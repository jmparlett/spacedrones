...
markerLength = 1.2  # Here, measurement unit is centimetre.

# Provide separation between markers
markerSeparation = 2.54   # Here, measurement unit is centimetre.

# create arUco board (7,10)
board = aruco.GridBoard_create(8, 11, markerLength, markerSeparation, aruco_dict)
