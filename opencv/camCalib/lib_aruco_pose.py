...
taken from https://github.com/tizianofiorenzani/how_do_drones_work/blob/master/opencv/lib_aruco_pose.py
...
if __name__ == "__main__":
    ...
    aruco_tracker = ArucoSingleTracker(id_to_find=5, marker_size=100, show_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
