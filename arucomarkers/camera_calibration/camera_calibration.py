...
This code is taken from abakisita@github.com

https://github.com/abakisita/camera_calibration/blob/master/camera_calibration.py
...
calib_imgs_path = root.joinpath("calib_images")

# For validating results, show aruco board to camera.
aruco_dict = aruco.getPredefinedDictionary( aruco.DICT_ARUCO_ORIGINAL)

#Provide length of the marker's side
markerLength = 1.13  # Here, measurement unit is centimetre.

# Provide separation between markers
markerSeparation = 2.65   # Here, measurement unit is centimetre.

# create arUco board (7,10)
board = aruco.GridBoard_create(7, 10, markerLength, markerSeparation, aruco_dict)
